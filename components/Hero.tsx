  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6 fade-in">
        <h1 className="text-5xl md:text-7xl font-playfair font-bold mb-6 text-foreground">IT Trend Agency</h1>
        <p className="text-xl md:text-2xl mb-8 text-muted-foreground max-w-2xl mx-auto">
          Crafting Digital Experiences Through
          <span className="text-primary"> 3D Animations</span>,<span className="text-primary"> Web Development</span>,
          <span className="text-primary"> Games</span> &<span className="text-primary"> Design</span>
        </p>
